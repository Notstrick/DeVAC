		...
		function SectionFunctions:Tab(Settings)
			...
			function TabFunctions:Section(Settings)
				...
				function SectionFunctions:Slider(Settings, Flag)
					...
					sliderBar.Position = UDim2.fromScale(0.219, 0.5)
					sliderBar.AnchorPoint = Vector2.new(0, 0.5)
					sliderBar.Size = UDim2.fromOffset(123, 30)

					local sliderBarUICorner = Instance.new("UICorner")
					sliderBarUICorner.Name = "SliderBarUICorner"
					sliderBarUICorner.CornerRadius = UDim.new(0, 6)
					sliderBarUICorner.Parent = sliderBar

					local sliderBarUIStroke = Instance.new("UIStroke")
					sliderBarUIStroke.Name = "SliderBarUIStroke"
					sliderBarUIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
					sliderBarUIStroke.Color = Color3.fromRGB(100, 100, 100)
					sliderBarUIStroke.Transparency = 0.2
					sliderBarUIStroke.Thickness = 1
					sliderBarUIStroke.Parent = sliderBar
					...
					sliderFillUICorner.Name = "SliderFillUICorner"
					sliderFillUICorner.CornerRadius = UDim.new(0, 6)
					...
					sliderValueText.FontFace = Font.new(assets.interFont)
					sliderValueText.Text = "0"
					sliderValueText.TextColor3 = Color3.fromRGB(211, 211, 211)
					sliderValueText.TextSize = 12
					sliderValueText.TextTransparency = 0
					...
					sliderValueText.Size = UDim2.fromScale(1, 1)
					sliderValueText.ZIndex = 3
					sliderValueText.Parent = sliderBar
					...
					local function SetValue(val, ignorecallback)
						...
						sliderValueText.Text = (Settings.Prefix or "") .. ValueDisplayMethod(finalValue, SliderFunctions.Settings.Precision) .. (Settings.Suffix or "")

						local accentColor = (hovered or inUse) and Color3.fromRGB(100, 149, 237) or Color3.fromRGB(30, 144, 255)
						Tween(sliderFill, TweenInfo.new(0.1, Enum.EasingStyle.Sine), {
					...
					sliderBar.MouseEnter:Connect(function()
						hovered = true
						if not inUse then
							local accentColor = Color3.fromRGB(100, 149, 237)
							Tween(sliderFill, TweenInfo.new(0.1, Enum.EasingStyle.Sine), {
								BackgroundColor3 = accentColor
							}):Play()
						end
					...
					sliderBar.MouseLeave:Connect(function()
						hovered = false
						if not inUse then
							local accentColor = Color3.fromRGB(30, 144, 255)
							Tween(sliderFill, TweenInfo.new(0.1, Enum.EasingStyle.Sine), {
								BackgroundColor3 = accentColor
							}):Play()
						end
					...
					local function updateSliderBarSize()
						...
						local newBarWidth = (totalWidth - (padding + sliderNameWidth + 20)) / baseUIScale.Scale
